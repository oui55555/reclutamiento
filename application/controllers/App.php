			...
			{ 
				...
				if($query)
					...
					foreach ($user->result() as $user_cell)
					{
						...
						$data ['user_name']= $user_cell->user_event_name;
						$data ['user_lastName']= $user_cell->user_event_lastName;						
						$data ['user_id']= $user_cell->user_event_id;
												
					}

				$this->session->set_userdata($data);
				
				redirect('app_home/valid_user/calendar');
